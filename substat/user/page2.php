	...
	<div class="topnav">
		<div class="navindex">
      	...
      	<div class="logout">
      		...
      		<a href="page1.php" class=""><h4><strong>Pengajuan</strong></h4></a>
          	</div>
      	</div>
    </div>
    <?php
    ...
    <div class="container">
    	<ul class="tabs">
			<li>
				...
				<label for="tab1">Tabel User</label>
				<div id="tab-content1" class="tab-content" style="overflow-x:auto;">
					...
					<table class="tableuser">
						...
						<tbody>
							<?php
								...
								include '../../include/connection.php';
								$query = "SELECT * FROM pengajuan ORDER BY idproject limit $start,$perpage";
					...
					<li>
						...
						<label for="tab3">Tabel Optima</label>
					...
					<li>
						...
						<label for="tab2">Tabel Mitra</label>
